...
- 2026-06-17: Created GitHub-ready public repository structure from `pifs_ru_journal_v3_submission.zip`.
...
- Choose and add an explicit license if public reuse is intended.
- Add citation metadata if the manuscript needs a stable academic citation format.
- Add rerun scripts only if experiments need to be regenerated from source, not just archived.
