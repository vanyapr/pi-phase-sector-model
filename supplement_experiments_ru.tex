...
Эксперименты 001--009 показывают, какие простые предикторы не дают результата.  Эксперименты 010--018 показывают положительный контур: конечный поиск и сертифицированное продолжение при наличии внешнего секторного сертификата.  Поэтому итоговая граница такова:
\begin{itemize}
